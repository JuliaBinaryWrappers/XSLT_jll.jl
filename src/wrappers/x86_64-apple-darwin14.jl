# Autogenerated wrapper script for XSLT_jll for x86_64-apple-darwin14
...
const libexslt_splitpath = ["lib", "libexslt.0.dylib"]
...
const libexslt = "@rpath/libexslt.0.dylib"


# Relative path to `libxslt`
const libxslt_splitpath = ["lib", "libxslt.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libxslt = "@rpath/libxslt.1.dylib"
