...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import XSLT_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("aed1982a-8fda-507f-9586-7b0439959a61"))
...
if best_platform === nothing
    @debug("Unable to load XSLT; unsupported platform $(triplet(platform_key_abi()))")
else
